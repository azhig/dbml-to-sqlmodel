...
class AppConfig(BaseModel):
    ...
    schema_file: str = Field(
        default="examples/schema.dbml", description="Default DBML schema file path"
    )
    ...
    show_new_content: bool = Field(
        default=False, description="Show content of new files in preview by default"
    )
    force_overwrite: bool = Field(
        default=False, description="Force overwrite protected files by default"
    )
