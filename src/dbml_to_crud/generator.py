...
from .dbml_to_sqlmodel import parse_dbml, parse_dbml_enums, generate_single_model, TableInfo, to_class_name
...
def generate_admin_views(tables: list[TableInfo]) -> str:
...
def generate_all_files(dbml_content: str) -> Dict[str, str]:
    """
    ...
    # Create admin.py
    files["admin.py"] = generate_admin_views(tables)
